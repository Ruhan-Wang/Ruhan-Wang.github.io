...
\item Conference Reviewer: International Conference on Machine Learning (ICML) --- \textbf{Gold Reviewer, 2026}
...
\small
\resumeSubheading
{More Memory, Worse Agents: Error Reproduction and Anti-Persistence in LLM Agents}{Indiana, US}
